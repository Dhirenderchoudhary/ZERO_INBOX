...
```css
/* Font Scale */
--text-xs: 11px / line-height: 16px --text-sm: 13px / line-height: 20px
  --text-base: 14px / line-height: 22px --text-md: 15px / line-height: 24px
  --text-lg: 17px / line-height: 26px --text-xl: 20px / line-height: 30px
  --text-2xl: 24px / line-height: 34px --text-3xl: 30px / line-height: 40px
...
```css
--radius-sm: 4px /* Tags, badges */ --radius-md: 8px /* Cards, inputs */
  --radius-lg: 12px /* Modals, panels */ --radius-xl: 16px /* Large cards */
  --radius-2xl: 20px /* Floating chat bubbles */ --radius-full: 9999px
...
```css
--transition-fast: 100ms ease --transition-base: 200ms ease
...
```
┌──────────────────────────────────┐
│ [●] demo.user@gmail.com ▾  │   ← Google account switcher
└──────────────────────────────────┘
```
...
_Standard row (60px height in default density):_
...
_Row hover action bar (replaces preview text on hover):_
...
_Email message controls (top-right of each email):_
...
_Attachment area (if email has files):_
...
│  > Hi DEMO USER, The updates we're proudest of...               │
│                                                              │
│ ──────────────────────────────────────────────────────────  │
...
```
     ⚡ Welcome to ZERO INBOX, User!

  Let's set up your workspace.

  ✓ Gmail connected (demo.user@gmail.com)
...
_End of Specification — Version 1.0_
_This document covers every screen, component, interaction, color, typography, AI feature, and layout rule needed to implement the Corsair Productivity OS from scratch._
